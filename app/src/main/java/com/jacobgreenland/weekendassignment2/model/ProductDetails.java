...
import com.jacobgreenland.weekendassignment2.model.Unused.AssosciatedProducts;
import com.jacobgreenland.weekendassignment2.model.Unused.Variant;
...
public class ProductDetails extends RealmObject {
    ...
    @Expose
    @Ignore
    private List<AssosciatedProducts> associatedProducts = new ArrayList<AssosciatedProducts>();
     ...
     */
    public List<AssosciatedProducts> getAssociatedProducts() {
     ...
     * The AssociatedProducts
     */
    public void setAssociatedProducts(List<AssosciatedProducts> associatedProducts) {
